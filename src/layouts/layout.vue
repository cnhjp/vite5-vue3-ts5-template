...
<template>
  <n-layout has-sider :class="layoutClassList">
    <LayoutHeader :class="layoutHeaderClassList" />
    <LayoutSider :class="layoutSiderClassList" />
    <LayoutContent :class="layoutContentClassList" />
    <LayoutFooter :class="layoutFooterClassList" />
  </n-layout>
</template>
